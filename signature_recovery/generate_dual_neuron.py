...
cluster_files = [
    os.path.join(BASE_DIR, "signature_recovery/exp/1-cluster-0.p"),
    os.path.join(BASE_DIR, "signature_recovery/exp/1-cluster-1.p"),
    os.path.join(BASE_DIR, "signature_recovery/exp/1-cluster-2.p"),
    os.path.join(BASE_DIR, "signature_recovery/exp/1-cluster-3.p"),
    os.path.join(BASE_DIR, "signature_recovery/exp/1-cluster-4.p")
]
output_dir = os.path.join(BASE_DIR, "sign_recovery/layer_neuron_npys")
