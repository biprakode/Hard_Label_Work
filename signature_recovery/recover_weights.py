...
def dosteal(LAYER, cluster):
    ...
    layer_dir = os.path.join(os.path.join(BASE_DIR, 'signature_recovery/outputs/model_weights/Vrelu'), f"layer_{LAYER}")
...
if __name__ == '__main__':
    ...
    dosteal(layer, pickle.load(open(os.path.join(BASE_DIR, "signature_recovery/exp/1-cluster-%d.p")%layer,"rb")))
